...
- [ ] E.4 (E.4.1-E.4.3.3 abgeschlossen) E-Rechnung Ausgang (XRechnung, ZUGFeRD 2.x) — wip, in Subtasks zerlegt (§6.3, analog zu Epic D/E.1/E.2/E.3)
  ...
  - [ ] E.4.3 (E.4.3.1-E.4.3.3 abgeschlossen) Anwendungscode: CII-XML-Builder, DB-Abfrage/Mapping, HTTP-Wiring (XRechnung + ZUGFeRD-PDF-Embedding), Tests — wip. Größenschätzung bestätigt sich (verschachtelte CII-Struktur mit vier Ebenen, zwei Endpunkte, PDF-Embedding-Logik, mehrere Testfälle inkl. Negativfälle) und überschreitet §6.3 — wie in ADR 0022 "Konsequenzen" vorgezeichnet in vier Micro-Subtasks zerlegt (analog D.3.3/E.2.3/E.3.3): E.4.3.1 (reiner CII-Serialisierer, DB-los, vollständig eigenständig verifizierbar), E.4.3.2 (DB-Abfrage/Mapping inkl. Käuferadress-Auflösung und Steuerkategorie-Ableitung), E.4.3.3 (HTTP-Wiring XRechnung), E.4.3.4 (ZUGFeRD-PDF-Embedding, letzte Subtask von Task E.4).
    ...
    - [ ] E.4.3.4 (letzte Subtask von Task E.4) ZUGFeRD: CII-XML als `factur-x.xml` per `gofpdf.SetAttachments` in die bestehende Rechnungs-PDF einbetten, `GET /invoices-out/{id}/zugferd` (`application/pdf`) + End-to-End-Integrationstest — todo. Bekannte, in ADR 0022 offengelegte Einschränkung: keine formale PDF/A-3-Konformität erreichbar.
