...
- [ ] E.4 (E.4.1-E.4.2 abgeschlossen) E-Rechnung Ausgang (XRechnung, ZUGFeRD 2.x) — wip, in Subtasks zerlegt (§6.3, analog zu Epic D/E.1/E.2/E.3)
  ...
  - [ ] E.4.3 (letzte Subtask von Task E.4) Anwendungscode: CII-XML-Builder, DB-Abfrage/Mapping, HTTP-Wiring (XRechnung + ZUGFeRD-PDF-Embedding), Tests — todo. Größenschätzung (verschachtelte CII-Struktur, zwei Endpunkte, PDF-Embedding-Logik, mehrere Testfälle inkl. Negativfälle) wird voraussichtlich §6.3 überschreiten — bei Erreichen in Micro-Subtasks zerlegen (analog D.3.3/E.2.3/E.3.3).
