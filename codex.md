Nächste zu bearbeitende Subtask: Subtask 2.2.1.3 / Micro-Subtask 7 / Micro-Subtask 79: Nach der Zentralisierung der verknüpften Material-Suffixe verbleibende kleine Display-/Navigation-Dopplungen weiter prüfen, insbesondere ob Projektmaterial-Titel und Beschreibungspfade noch enger an gemeinsame Helper gebunden werden können

Aktueller Git-Stand: client/lib/project_navigation.dart enthält jetzt buildProjectLinkedMaterialSuffix(...). client/lib/pages/projects_page.dart verwendet diesen Helper für Profil-, Artikel- und Glas-Subtitles. client/test/sales_order_context_pages_test.dart deckt den neuen Helper zusätzlich ab. Die gesamte Kontextsuite bleibt grün; zuvor eingeführte Shared-Context- und Flow-Builder bleiben unverändert aktiv.

Zusammenfassung für Fortsetzung (max 1200 Tokens):
Micro-Subtask 78 ist abgeschlossen. Ziel war eine weitere kleine Display-Duplikation im Projektmaterial-Pfad: In projects_page.dart wurde der Suffix • verknüpft: <material_nummer> in den Listen für Profile, Artikel und Glas mehrfach lokal zusammengesetzt, teilweise sogar mit doppeltem Aufruf von resolveProjectLinkedMaterialLabel(...) innerhalb derselben String-Interpolation. In client/lib/project_navigation.dart wurde deshalb der neue Helper buildProjectLinkedMaterialSuffix(Map<String, dynamic> item) ergänzt. Er kapselt die Semantik für dieses Anzeigesuffix: wenn resolveProjectLinkedMaterialLabel(item) keinen Wert liefert, kommt ein leerer String zurück; andernfalls exakt • verknüpft: <label>. In client/lib/pages/projects_page.dart verwenden nun die drei Materiallisten denselben Helper. Bei Profilen entfielen die lokalen Zwischenvariablen linkedLabel und linkedStr; bei Artikeln und Glas verschwand die bisher schwer lesbare Inline-Bedingung mit doppeltem Funktionsaufruf. Das ist bewusst eine kleine Konsolidierung ohne Funktionsänderung, verbessert aber Lesbarkeit und macht die Anzeige-Semantik an einer Stelle änderbar. In client/test/sales_order_context_pages_test.dart wurde der bestehende Resolver-Test Project material resolvers derive title and linked label consistently erweitert: Er prüft jetzt zusätzlich, dass buildProjectLinkedMaterialSuffix(item) für MAT-001 den erwarteten Suffix liefert und bei leerer material_nummer einen leeren String zurückgibt. Nach dart format auf project_navigation.dart, projects_page.dart und die Testsuite lief pwsh -File ..\scripts\client_tooling.ps1 -Action test -TestTarget test/sales_order_context_pages_test.dart erfolgreich mit All tests passed!. Nächster sinnvoller Schritt: weitere kleine Display-/Navigation-Dopplungen im Projektmaterial-Pfad prüfen, insbesondere ob Titel- und Beschreibungsableitungen für Projektmaterialien noch enger an gemeinsame Helper gebunden werden können.
=== CODEX STATE [ENDE]